...
from structures.queues import Stack, FifoQueue
...
def is_valid_brackets_count(value: str) -> bool:
	"""	checks that the parentheses are written in the correct order and number
		the function is not sensitive to different types of parentheses
